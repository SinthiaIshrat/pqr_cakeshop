...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="flex">
         <p class="price"><?= $fetch_cart['price']; ?> TK</p>
      ...
      <p class="sub-total">sub total : <span><?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?> TK</span></p>
   ...
   <?php if($grand_total != 0){ ?>
      <div class="cart-total">
         <p>grand total : <span><?= $grand_total; ?> TK</span></p>
