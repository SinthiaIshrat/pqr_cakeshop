      ...
      <div class="summary">
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"><?= $fetch_get['price']; ?> TK x 1</p>
            </div>
         </div>
         <?php
               }
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"><?= $fetch_product['price']; ?> TK x <?= $fetch_cart['qty']; ?></p>
            </div>
         </div>
         <?php
                  }
         ...
         ?>
         <div class="grand-total"><span>grand total :</span><p><?= $grand_total; ?> TK</p></div>
      </div>
